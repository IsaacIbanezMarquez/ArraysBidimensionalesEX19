...
{
    //10) Crea dos arrays multidimensionales de 2×3 y rellenalos como quieras (números aleatorios, por teclado
    // o definido al crear el array).
    //
    //Haz un método que sume los arrays multidimensionales, es decir, la posición 0, 0 del array1 con la posición del
    // array2 y así sucesivamente, este metodo no debe devolver nada, haciendo que deba pasarse el array
    // multidimensional de suma como parámetro. Muestra el contenido de cada array multidimensional.
